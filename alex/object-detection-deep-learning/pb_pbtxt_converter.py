...
input = '/Users/alexdodd/Documents/CMPE 258 Deep Learning/traffic-sign-recognition/output/trafficsignnet.model/saved_model.pb'

# Get input filename parts
in_dir = os.path.dirname(input)
in_name, in_ext = os.path.splitext(os.path.basename(input))
in_ext = in_ext.lower()
...
if to_pb:
    pbtxt_to_graphdef(input)
else:
    graphdef_to_pbtxt(input)